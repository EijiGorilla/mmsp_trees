...
import { cuttingStatusChart, treeCompensationLayer, treeCuttingLayer } from '../layers';
...
///*** Others */
/// Draw chart
const TreeCuttingChart = ({ contractp, stationname }: any) => {
  // 1. Land Acquisition
  ...
  useEffect(() => {
    ...
    pieSeries.slices.template.events.on('click', (ev) => {
      ...
      const find = cuttingStatusChart.find((emp: any) => emp.category === categorySelected);
